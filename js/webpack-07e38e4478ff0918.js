!function() {
    ...
    function l(e) {
        ...
        var r = d[e] = {
          ...
          , n = !0;
        try {
            f[e].call(r.exports, r, r.exports, l),
            n = !1
        } finally {
            n && delete d[e]
        }
    ...
    l.O = function(t, r, n, o) {
        ...
        for (var u = 1 / 0, i = 0; i < e.length; i++) {
            for (var r = e[i][0], n = e[i][1], o = e[i][2], c = !0, a = 0; a < r.length; a++)
                u >= o && Object.keys(l.O).every(function(e) {
                    return l.O[e](r[a])
                }) ? r.splice(a--, 1) : (c = !1,
                o < u && (u = o));
            if (c) {
    ...
    l.u = function(e) {
        return "static/chunks/" + (({
            ...
            707: "iNoBounce",
            709: "smoothScroll",
            854: "intersectionObserver",
            937: "polyfill.sticky"
        })[e] || e) + "." + ({
            50: "82e5f2bdce3bf6ba",
            179: "2a0bd9ab22f24655",
            519: "d8b88faaa161d7c7",
            632: "343a4a1e23232201",
            707: "070e90cafa8706df",
            709: "1845bc88d2f967ad",
            854: "49c245649bed7e8c",
            937: "51ed8cb3e8c9c839"
        })[e] + ".js"
    }
    ,
    ...
    l.l = function(e, t, r, i) {
        ...
        if (void 0 !== r)
            for (var u, c, a = document.getElementsByTagName("script"), f = 0; f < a.length; f++) {
                var d = a[f];
    ...
    ,
    l.p = "//www.nike.com/assets/experience/dotcom-browse/app/_next/",
    u = {
        272: 0
    },
    l.f.j = function(e, t) {
    ...
    ,
    (a = self.webpackChunk_N_E = self.webpackChunk_N_E || []).forEach(c.bind(null, 0)),
