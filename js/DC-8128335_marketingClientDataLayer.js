    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "function": "__ccd_fl_first",
                "priority": 1,
                "vtp_instanceDestinationId": "DC-8128335",
                "tag_id": 7
            }, {
                "function": "__rep",
                "vtp_containerId": "DC-8128335",
                "vtp_remoteConfig": ["map"],
                "tag_id": 1
            }, {
                "function": "__ccd_fl_last",
                "priority": 0,
                "vtp_instanceDestinationId": "DC-8128335",
                "tag_id": 6
            }],
        ...
        "blob": {
            "1": "1",
            "10": "DC-8128335|GT-M38QDH6S",
            "11": true,
            "14": "5bi1",
            "15": "0",
            "16": "ChAIgJX7yAYQ0oDHmfuv1bVZEhsAPKj1g/6hBZ36UXgRtDAZAEVapkqUJCeW/pQaAjbj",
            "17": "c",
        ...
        ,
        "security_groups": {
            "google": ["__ccd_fl_first", "__ccd_fl_last", "__e", "__ogt_1p_data_v2", "__rep"
            ]
...
*/
    ...
    ;var CK = function(a) {
      ...
      , GK = function(a, b, c) {
        if (P(a, O.A.ba) === Wi.N.Da)
            ...
            DK(a, d.Rd, function(e) {
                ...
                var h = function(v) {
                    Dn({
                        targetId: f.target.destinationId,
                        request: {
                            url: v,
                            parameterEncoding: 4,
                            endpoint: d.endpoint
                  ...
                  , l = {
                    destinationId: f.target.destinationId,
                    endpoint: d.endpoint,
                    eventId: a.D.eventId,
                    priorityId: a.D.priorityId
                }
                ...
                if (d.Kd) {
                    g.splice(-1, 0, "dc_random=" + P(a, O.A.di));
                    var p = "" + EK(d.Rd, a) + g.join(";") + "?"
                      , q = g.slice()
                      , r = function(v) {
                        var x;
                        if (!(v >= (((x = d.Kd) == null ? void 0 : x.length) || 0))) {
                            var y = d.Kd[v], z = n(q, "dc_fmt", y), D = "" + EK(y, a) + z.join(";") + "?", E;
                            a: switch (y) {
                            case 1:
                            case 2:
                                E = 4;
                            ...
                            var J = E;
                            J === 2 ? Cl(l, D, void 0, void 0, function() {
                                h(D);
                                a.D.onSuccess()
                            }, function() {
                                r(v + 1)
                    ...
                    Cl(l, p, void 0, P(a, O.A.Di) ? {
                        attributionReporting: FK
                    } : void 0, function() {
                        h(p);
                        a.D.onSuccess()
                    }, function() {
                ...
                var u = EK(d.Rd, a) + g.join(";") + "?";
                d.Kd || h(u);
                P(a, O.A.qh) ? El(l, EK(2, a) + g.join(";") + "?", a.D.onSuccess) : d.Kd || Bl(l, u, a.D.onSuccess, a.D.onFailure);
                if (P(a, O.A.Di) && !d.Kd) {
                    g = n(g, "dc_fmt", 10);
                    var t = "" + EK(10, a) + g.join(";") + "?";
                    Bl({
                        destinationId: f.target.destinationId,
                        endpoint: 33,
                        eventId: a.D.eventId,
      ...
      , DK = function(a, b, c) {
        for (var d = [], e = {}, f = function(E, J, K) {
            var R = K ? String(J) : encodeURIComponent(String(J));
            e[E] = R
        }, g = sd(Iu(a, L.m.Cc)) ? Iu(a, L.m.Cc) : {}, h = m(Object.keys(a.C)), l = h.next(); !l.done; l = h.next()) {
            var n = l.value
              , p = Iu(a, n)
              , q = HK[n];
            if (q) {
        ...
        t && f("prd", t, !0);
        f("epver", "2");
        Zl[Hl.aa.Ra] !== Gl.La.Ee || bm[Hl.aa.Ra].isConsentGranted() || f("limited_ads", "1");
        var v = Iu(a, L.m.ya);
        v && P(a, O.A.Ie) && (v = ou(String(v)));
        zb(g, function(E, J) {
            if (J != null)
                if (E === "~oref")
                    v = J;
                else {
                    var K = encodeURIComponent(E);
                    e[K] != null && N(141);
                    f(K, J)
                }
        });
      ...
      , IK = function(a) {
        ...
        for (var c = [], d = function(n, p, q) {
            ...
            var f = b[e]
              , g = F(72)
              , h = f.id;
            f.item_id !== void 0 && (g && (h = f.item_id),
            f.id !== void 0 ? (N(150),
            f.id !== f.item_id && N(151)) : N(152));
    ...
    var MK = function() {
      ...
      , NK = function(a) {
        if (F(231)) {
            var b = Yb();
            S(a, O.A.di, Math.floor(Gb() / 1E3) + "_" + b)
        } else
            S(a, O.A.di, P(a, O.A.eb))
    }
      , OK = function(a) {
        if (!(P(a, O.A.fa) || F(268) && a.eventName !== L.m.ma)) {
            var b = M(a.D, L.m.Jk);
            if (sd(b) && b.exclusion_parameters && b.engines) {
                var c = M(a.D, L.m.tb) !== !1
                  , d = Fu(a)
                  , e = function() {
                    if (Sn(MK())) {
                        var f = {
      ...
      , RK = function(a, b, c, d) {
        function e(p, q) {
            for (var r = m(g), u = r.next(); !u.done; u = r.next()) {
                var t = u.value;
                if (!P(t, O.A.fa) || P(t, O.A.ba) === Wi.N.Da || Sn(MK()))
                    if (!P(t, O.A.fa) || P(t, O.A.ba) !== Wi.N.Da || P(t, O.A.Zd) || !F(268)) {
                        for (var v = P(t, O.A.ba) === Wi.N.Da ? PK : QK, x = m(v), y = x.next(); !y.done; y = x.next()) {
                            var z = y.value;
                            z(t);
                            if (t.isAborted)
                                break
                        }
                        P(t, O.A.xa) || t.isAborted || (GK(t, p, q),
                        P(t, O.A.ba) !== Wi.N.Da || F(268) && !P(t, O.A.Zd) || Ju(t, function() {
                            e(p, q)
                        }))
                    }
            }
        ...
        if (f) {
            var g = []
              , h = new vF(f.target,b,d);
            S(h, O.A.rh, f);
            S(h, O.A.ba, Wi.N.kp);
            g.push(h);
            if (F(24) && (b === L.m.ma || F(268) && b !== L.m.Bb)) {
                var l = new vF(f.target,b,d);
                S(l, O.A.ba, Wi.N.Da);
                S(l, O.A.xa, !0);
                g.push(l)
            }
            ...
            Vn(function() {
                ...
                Sn(n) || Un(function(p) {
                    ...
                    for (var u = m(g), t = u.next(); !t.done; t = u.next()) {
                        var v = t.value;
                        S(v, O.A.fa, !0);
                        S(v, O.A.eb, Gb());
                        S(v, O.A.Xe, q);
      ...
      , QK = [GJ, VJ, fK, cK, hK, function(a) {
        var b = P(a, O.A.rh);
        S(a, O.A.Ei, b.xq);
        T(a, L.m.ri, b.target.ids[oo[3]]);
        T(a, L.m.Ok, b.bq);
        T(a, L.m.Nk, b.cq);
        S(a, O.A.eb, Gb());
        var c = M(a.D, L.m.ff) === !0
          , d = Sn(AI);
        S(a, O.A.qh, c && d);
        S(a, O.A.Ie, P(a, O.A.Tc) && !d);
        F(158) && S(a, O.A.wh, !0)
    }
    , function(a) {
        if (!P(a, O.A.fa)) {
            var b = a.D.isGtmEvent ? M(a.D, "oref") : vj(yj(w.location.href));
            T(a, L.m.ya, b)
        }
    }
    , function(a) {
        if (a.eventName === L.m.ma && !a.D.isGtmEvent) {
            if (!P(a, O.A.fa) && !F(24)) {
                var b = P(a, O.A.be)
                  , c = P(a, O.A.Fa)
                  , d = P(a, O.A.Tc);
                ...
                OK(a);
                var e = P(a, O.A.rh).target
                  , f = Sb(a.D.getMergedValues(L.m.Ga, 2), ".")
                  , g = Sb(a.D.getMergedValues(L.m.Ga, 1), ".")
                  , h = hq(!0);
                Iy({
                    fj: !0,
                    Vc: b ? c : void 0,
    ...
    , function(a) {
        var b = P(a, O.A.Ei);
        kb("GTAG_EVENT_FEATURE_CHANNEL", Fo[b]);
        switch (b) {
        case "standard":
            T(a, L.m.Ja, wb(1E11, 1E13));
            kb("GTAG_EVENT_FEATURE_CHANNEL", Bo.R.sh);
            return;
        case "unique":
            T(a, L.m.Ja, "1");
            T(a, L.m.Qk, wb(1E11, 1E13));
            kb("GTAG_EVENT_FEATURE_CHANNEL", Bo.R.sh);
            return;
        case "per_session":
            var c = M(a.D, L.m.Xb);
        ...
        var d = b === "transactions" ? "1" : M(a.D, L.m.ye);
        T(a, L.m.ye, d);
        a.copyToHitData(L.m.Ka);
        a.copyToHitData(L.m.Ja)
    }
    , function(a) {
        a.D.isGtmEvent && (a.copyToHitData(L.m.Sk),
        a.copyToHitData(L.m.Rk),
        a.copyToHitData(L.m.Af))
    }
    , function(a) {
        P(a, O.A.fa) && T(a, L.m.fa, "1")
    }
    , function(a) {
        qK(a, !1)
    }
    , rK, pK, gK, function(a) {
        if (P(a, O.A.be)) {
            ...
            if (P(a, O.A.qh)) {
                var h = ut(b.prefix) !== "_gcl", l;
                if (!(l = e)) {
                    var n = b.prefix;
                    l = !(Aj("gclaw") || Aj("gac") || (Nt().aw || []).length > 0 ? 0 : (Nt().gb || []).length > 0 || Nt().gbraid !== void 0 || mu(n))
                }
                if (l) {
                    var p = xu("aw", b.prefix, c);
                    p && p.length && (T(a, L.m.sb, p.join(".")),
                    N(59));
                    var q, r = Aj("gac");
                    (q = r ? !Sn(ru()) && c ? "0" : rj(r) || "" : wu(ot(nt()) ? Js() : {})) && (h || T(a, L.m.bh, q))
                } else {
                    var u;
                    a: {
                        var t = b.prefix
                        ...
                        if (v)
                            ...
                            if (x === "_gcl") {
                                var y = !Sn(ru()) && c
                                  , z = Nt()
                                  , D = [];
                                z.wbraid && D.push(z.wbraid);
                                z.gbraid && D.push(z.gbraid);
                                if (D.length > 0) {
                                    u = y ? ["0"] : D;
                                    break a
                                }
                    ...
                    var E = u;
                    E.length && T(a, L.m.sc, E.join("."));
                    if (!h) {
                        var J, K = Aj("gacgb");
                        (J = K ? !Sn(ru()) && c ? "0" : rj(K) || "" : wu(ot(nt()) ? Js("_gac_gb", !0) : {})) && T(a, L.m.ue, J)
                    }
                }
            }
        }
    ...
    , function(a) {
        ...
        if (b === "transactions" || b === "items_sold") {
            ...
            if (Array.isArray(c)) {
                if (!a.D.isGtmEvent)
                    for (var d = M(a.D, L.m.Bc), e = M(a.D, L.m.mb), f = m(c), g = f.next(); !g.done; g = f.next()) {
                        var h = g.value;
                        sd(h) && (h[L.m.Bc] = d,
                        h[L.m.mb] = e,
                        h.accountId = void 0)
    ...
    , function(a) {
        ...
        sd(b) && zb(b, function(g, h) {
            sb(h) && SK.test(g) && (c[g] = h)
        });
        for (var d = Ko(a.D), e = 0; e < d.length; e++) {
            var f = d[e];
            SK.test(f) && (c[f] = f)
        }
        zb(c, function(g, h) {
    ...
    , uJ, function(a) {
        var b = {};
        bK(a, !0, (b[L.m.sb] = L.m.Vg,
        b))
    }
    , function(a) {
        var b = Sn(MK()) && QI();
        S(a, O.A.Di, b);
        b && !P(a, O.A.wh) && (T(a, L.m.kd, "1"),
        T(a, L.m.Pk, wb()))
    }
    , FJ, wK, sJ, oK, nK, NK, ZJ, xK, lK]
      , PK = [GJ, VJ, fK, oK, aK, function(a) {
        F(268) && dK(a, {
            tj: !0,
            mj: !0,
            dn: !0
